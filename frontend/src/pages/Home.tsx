  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '40px' }}>
      ...
      <div style={{ display: 'flex', gap: '30px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '60px' }}>
        <Link to="/consume" style={buttonStyle('#ef4444')}>📤 {i18n.nav.consume}</Link>
        <Link to="/restock" style={buttonStyle('#10b981')}>📥 {i18n.nav.restock}</Link>
        <Link to="/manage" style={buttonStyle('#4b5563')}>⚙️ {i18n.nav.manage}</Link>
      </div>
